...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BillNumberAlreadyExistsException.class)
    public ResponseEntity<Map<String, Object>> handleBillNumberAlreadyExists(BillNumberAlreadyExistsException ex) {
        logger.error("Bill number already exists: {}", ex.getMessage());
        return buildResponse(HttpStatus.CONFLICT, "Bill Number Already Exists", ex.getMessage());
    }

    @ExceptionHandler(BillNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleBillNotFound(BillNotFoundException ex) {
        logger.error("Bill not found: {}", ex.getMessage());
        return buildResponse(HttpStatus.NOT_FOUND, "Bill Not Found", ex.getMessage());
    }
